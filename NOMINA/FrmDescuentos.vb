Public Class FrmDescuentos
    ...
    Private Sub FrmDescuento_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        scr = "SELECT * FROM TB_TIPODESC"
        If cs.consultas(scr, dt_codesc, msj) Then
            Cbtipodesc.DataSource = dt_codesc
            CbTipoDesc.ValueMember = "codigo"
            CbTipoDesc.DisplayMember = "descripcion"
        End If
    ...
    Private Sub BtGuardar_Click(sender As System.Object, e As System.EventArgs) Handles BtGuardar.Click
        ...
        Else
            ...
            If cs.descuento(codigo, empresa, Format(fec_inic, "yyyy-MM-dd"), monto, Cbtipodesc.SelectedValue, coment) Then
                MsgBox("DESCUENTO GUARDADA!!")
            Else
                mensajes.Text = msj
            End If
        End If
