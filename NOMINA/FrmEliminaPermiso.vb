Public Class FrmEliminaPermiso
    ...
    Private Sub Consultar()
        scr = "select a.*, nombre,SEGUNDO_NOMBRE,APELLIDO,SEGUNDO_APELLIDO from tb_permiso AS A" & _
    ...
    Private Sub BtGuardar_Click(sender As System.Object, e As System.EventArgs) Handles fg.Click
        ...
        If fg(fila, 5) = True Then
            scr = "delete from tb_permiso where codigo = " & fg(fila, 1) & " and fecha = '" & fg(fila, 2) & "'"
