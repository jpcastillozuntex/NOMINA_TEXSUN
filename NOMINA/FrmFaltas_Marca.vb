...
Public Class FrmFaltas_Marca
    ...
    Private Sub BtBuscar_Click(sender As System.Object, e As System.EventArgs) Handles BtBuscar.Click
        ...
        limpia_fg()
        dtfinal.Clear()
        scr = "SELECT A.NOMBRE,SEGUNDO_NOMBRE,APELLIDO,SEGUNDO_APELLIDO,C.NOMBRE AS DEPTO,B.FECHA,A.MARCA,A.ESTADO_EMPLEADO,A.FEC_ALTA,B.COMENT,A.CODIGO,B.COD_EMPRESA FROM TB_EMPLEADO AS A " & _
            " LEFT JOIN TB_FALTAS_MARCA AS B ON A.CODIGO = B.CODIGO AND A.CODIGO_EMPRESA = B.COD_EMPRESA AND FECHA BETWEEN '" & fecha_inic & "' AND '" & fecha_fin & "'" & _
        ...
        Else
            ...
            Else
                GroupBox1.Enabled = True
            End If
            If dtfechas.Rows(0)("MARCA") = "S" Then
                ' BtGuardar.Enabled = True
                mensajes.Text = ""
                cs.consultas(scr, dtfechas, msj)
                ...
                Next
            ElseIf dtfechas.Rows(0)("MARCA") = "N" Then
                mensajes.Text = "EMPLEASO NO MARCA"
            End If
    ...
    Private Sub BtGuardar_Click(sender As System.Object, e As System.EventArgs) Handles BtGuardar.Click
        ...
        For i = 1 To 16
            ...
            fec_tem = fec_tem.AddDays(1)
        Next
        If cs.gurda_faltas_marca(dt_ciclo.Rows(0)("inicio"), dt_ciclo.Rows(0)("fin"), dtfinal, msj, dtfechas) = False Then
            MsgBox(msj)
        Else
