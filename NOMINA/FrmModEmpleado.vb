...
Public Class FrmModEmpleado
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles BtBuscar.Click
        ...
        "a.ID_FOTO, SUELDO_BASE, BONIFICACION,CODIGO_RELOJ, NUM_LOCKER, VAC_LIQ, MARCA, TURNO, AF_IRTRA, HORAS_EX, K.NOMBRE as EMP_PAGA,A.LOCKER,A.ESTADO_EMPLEADO,A.TURNO_D,CENTRO,A.SUELDO_FIJO,A.SUELDO_MAX" & _
        ...
        Try
            If cs.consultas(scr, dt_select_d, msj) Then
                ...
                If dt_select_d.Rows(0)("SUELDO_FIJO") = "S" Then
                    Rbsueldosi.Checked = True
                ElseIf dt_select_d.Rows(0)("SUELDO_FIJO") = "N" Then
                    Rbsueldono.Checked = True
                End If
                ...
                TxtCodigoreloj.Text = dt_select_d.Rows(0)("codigo_reloj").ToString
                ...
                CbTurno.SelectedValue = dt_select_d.Rows(0)("turno_d").ToString
                texSueldomax.Text = dt_select_d.Rows(0)("SUELDO_MAX").ToString
    ...
    Private Sub cb_depart()
        scr = "SELECT NOMBRE,COD_DEPAR FROM TB_DEPTOS_EMPRESA order by nombre"
    ...
    Private Sub cb_turno()
        scr = "select turno,entrada+'-'+salida as nombre from tb_turno"
        If cs.consultas(scr, dt_centro, msj) Then
            CbTurno.DataSource = dt_centro
            CbTurno.DisplayMember = "nombre"
            CbTurno.ValueMember = "turno"
        Else
            MsgBox(msj)
        End If
    End Sub
    ...
    Private Sub crea_tabla()
        ...
        datos.Columns.Add("turno_d")
        datos.Columns.Add("sueldo_fijo")
        datos.Columns.Add("sueldo_max")
    ...
    Private Sub BtGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtGuardar.Click
        ...
        ElseIf Rbnoc.Checked = True Then
            turno = "NOC"
        End If
        If Rbsueldosi.Checked = True Then
            sueldo_fijo = "S"
        ElseIf Rbsueldono.Checked = True Then
            sueldo_fijo = "N"
        End If
        ...
        Else
            If Rbsueldono.Checked = False And Rbsueldosi.Checked = False Then
            ElseIf Rbsueldosi.Checked = True And texSueldomax.Text = "" Then
                MsgBox("Debe ingresar un sueldo fijo si!")
            Else
                ...
                dr("turno_d") = CbTurno.SelectedValue
                If Rbsueldosi.Checked = True Then
                    dr("sueldo_fijo") = "S"
                    dr("sueldo_max") = texSueldomax.Text
                Else
                    dr("sueldo_fijo") = "N"
                    dr("sueldo_max") = "0"
                End If
    ...
    Private Sub CbCods_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles CbCodigo.KeyPress
        cs.AutoCompletar(CbCodigo, e)
    End Sub
    ...
    Private Sub CbDeptoFin_SelectedIndexChanged(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub CbCodigo_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles TxtDepar.KeyPress
        cs.AutoCompletar(TxtDepar, e)
    End Sub

    Private Sub Cbpuesto_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles CbPuesto.KeyPress
        cs.AutoCompletar(CbPuesto, e)
    End Sub
