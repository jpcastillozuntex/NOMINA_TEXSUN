Public Class Frmnuevoanticipo
    ...
    Private Sub Frmnuevoanticipo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        scr = "select quincena from tb_ciclo_nomina where estado = 'A'"
        cs.csescalar(dt_quincena, scr, msj)

        CbCiclo.Text = dt_quincena
    ...
    Private Sub Combo_box_Mes()
        'Dim mes As Integer
        scr = "SELECT MES, NUMERO FROM MES WHERE NUMERO = (SELECT MES FROM TB_CICLO_NOMINA WHERE ESTADO = 'A')"
